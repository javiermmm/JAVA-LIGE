...
public class UIConsola extends UI {
	...
	/**
	 * Procedimiento que se encarga de mostrar el pequeño menu 
	...
	private void menuEligeJugador() {
		...
		System.out.println("3.- Jugador IA Mejorada (Se realizaran disparos aleatorios, hasta acertar a un barco, en ese momento se disparará con intencion))");
		System.out.println();
	}
